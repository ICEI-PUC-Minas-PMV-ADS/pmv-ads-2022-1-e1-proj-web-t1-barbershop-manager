...
| Clentes(s) de Barbearia |	Cadastrar os dados pessoais dos clientes. | 	Consolidar uma conta, com a finalidade de, promover um histórico de informações importantes de cada cliente da barbearia, para caso necessitar fazer um contato ou atualizar os dados constantemente dos clientes. |
