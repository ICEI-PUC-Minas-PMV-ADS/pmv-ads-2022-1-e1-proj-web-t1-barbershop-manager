...
|---------------------|--------------------------|-----------------------|
| Dono de Barbearia |	Montar o agendamento de funcionários diariamente |	Tomar ciência de quais funcionários irão atender os clientes na barbearia, deixando a escolha do cliente de qual o barbeiro optar pelo atendimento. |
| Barbeiro(s) |	Atribuir uma disponibilidade diária e horários dentro da barbearia |	Para tornar passível as escalas de cada colaborador na montagem do quadro de funcionários, a fim de ser administrado pelo dono da barbearia. |
| Dono de Barbearia |	Cadastrar os dados pessoais dos clientes. | 	Consolidar uma lista, com a finalidade de promover um histórico de informações importantes de cada cliente da barbearia, para caso necessitar fazer um contato ou oferecer um serviço gratuito/com desconto como exemplo no aniversário da pessoa. |
| Cliente(s) de Barbearia |	Agendamento de horários pelo site |	Priorizar atendimento no horário estabelecido do(s) serviço(s) prestado(s) aos clientes. |
| Cliente(s) de Barbearia |	Visualização da lista dos serviços prestados na barbearia |	Com o detalhamento de todos os serviços que a barbearia oferece, fica fácil do cliente escolher o serviço de sua preferência e o barbeiro saber o que será solicitado pelo cliente. |
| Cliente(s) de Barbearia |	Quais serão as formas de pagamento |	Identificar no site quais são os tipos de pagamento oferecidos na barbearia, sendo que ao chegar no estabelecimento possa estar ciente de como pagar o serviço prestado. |
| Cliente(s) de Barbearia |	Ter acesso ao telefone e endereço  da barbearia |	Caso o cliente necessite de qualquer suporte, ocorre um imprevisto ou até mesmo ser mais um meio facilitador da comunicação. É necessário que tenha o contato da barbearia, para quaisquer esclarecimentos. |
...
|RF-03|	O site deve permitir que usuários administradores sejam capazes de alterar os horários disponíveis para agendamento.	|Alta|
...
|RF-09|	O site deve permitir que o usuário especifique suas restrições de serviço	|Alta|
|RF-10|	O site deve permitir que um usuário faça mais de um agendamento.	|Baixa|
|RF-11| O site deve apresentar, à todos os momentos, o endereço da barbearia.	|Alta|
|RF-12|	O site deve ter uma funcionalidade de login para seus usuários	|Alta|
